...
<Helmet>
  <title>두산위브더제니스 청주 센트럴파크 - 체크포인트</title>
  <meta
    name="description"
    content="두산위브더제니스 청주 센트럴파크 분양 전 필수 체크포인트를 확인하세요. 청약 자격(거주기간·무주택·예치금), 특별공급 유형, 필요서류·일정, 유의사항을 한눈에 안내합니다."
  />
...
<h1 className={styles.screenReaderOnly}>
  두산위브더제니스 청주 센트럴파크 - 체크포인트
</h1>
<p className={styles.screenReaderOnly}>
  두산위브더제니스 청주 센트럴파크 분양 전 확인해야 할 핵심 체크리스트입니다.
...
<div className={styles.textBox}>
  ...
  <div>두산위브더제니스 청주 센트럴파크, 분양 전 체크포인트를 확인하세요.</div>
</div>
      ...
      {/* <img
        ...
        src={page1}
        alt="두산위브더제니스청주센트럴파크청약제도 변경안내 이미지1"
