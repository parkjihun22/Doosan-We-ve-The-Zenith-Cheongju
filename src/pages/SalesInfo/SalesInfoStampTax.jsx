  ...
  return (
    <div className={styles.container}>
      ...
      {/* <h1> 태그를 사용하여 페이지 제목 설정 (SEO 최적화) */}
          ...
          두산위브더제니스 청주 센트럴파크 - 인지세 안내
        </h1>
        <p className={styles.screenReaderOnly}>
          두산위브더제니스 청주 센트럴파크의 인지세 안내 페이지는
          분양 계약과 관련된 세금 정보를 제공합니다.
          인지세는 계약서 작성 시 부과되는 세금으로,
          사전에 정확히 파악하고 준비하는 것이 중요합니다.
          본 페이지에서는 인지세의 개념과 세액 기준,
          납부 절차 및 유의사항을 알기 쉽게 안내하여
          계약 준비에 도움을 드립니다.
        </p>

        <div className={styles.textBox}>
          <div>계약 전 인지세 안내를 확인하세요</div>
          <div>두산위브더제니스 청주 센트럴파크, 계약 준비의 시작</div>
        </div>
      ...
      <img
        ...
        src={page1}
        alt="두산위브더제니스청주센트럴파크인지세안내-image1"
