...
<Helmet>
  <title>두산위브더제니스 청주 센트럴파크 - 커뮤니티</title>
  <meta
    name="description"
    content="두산위브더제니스 청주 센트럴파크의 커뮤니티 시설을 소개합니다. 피트니스센터, 실내 골프연습장, 작은도서관(북카페), 주민 라운지 등 입주민의 생활 품격을 높이는 다양한 편의시설을 만나보세요."
  />
  ...
  <meta property="og:title" content="두산위브더제니스 청주 센트럴파크 - 커뮤니티" />
  <meta
    property="og:description"
    content="피트니스·실내골프·작은도서관·라운지 등 다양한 커뮤니티로 일상의 가치를 높이는 두산위브더제니스 청주 센트럴파크."
  />
...
<h1 className={styles.screenReaderOnly}>
  두산위브더제니스 청주 센트럴파크 - 커뮤니티
</h1>
<p className={styles.screenReaderOnly}>
  두산위브더제니스 청주 센트럴파크의 커뮤니티 페이지에서는 단지 내 다양한 시설을 소개합니다.
...
<div className={styles.textBox}>
  ...
  <div>두산위브더제니스 청주 센트럴파크의 커뮤니티를 만나보세요.</div>
</div>
      ...
      <img
				...
				src={page1}
				alt="두산위브더제니스청주센트럴파크커뮤니티 안내 -image1"
