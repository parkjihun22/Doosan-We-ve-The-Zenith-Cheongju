...
<Helmet>
  <title>두산위브더제니스 청주 센트럴파크 - 동·호수 배치</title>
  <meta
    name="description"
    content="두산위브더제니스 청주 센트럴파크 동·호수 배치도를 통해 세대별 위치와 조망, 일조 방향, 프라이버시를 고려한 설계를 확인하세요. 라인·스택 구성 및 코어 동선 정보를 한눈에."
  />
  ...
  <meta property="og:title" content="두산위브더제니스 청주 센트럴파크 - 동·호수 배치" />
  <meta
...
<h1 className={styles.screenReaderOnly}>
  두산위브더제니스 청주 센트럴파크 - 동·호수 배치
</h1>
<p className={styles.screenReaderOnly}>
  본 페이지에서는 동·호수 배치와 세대별 위치, 라인·스택 구성,
  코어(엘리베이터/계단) 동선 등을 제공합니다.
  원하는 호수를 빠르게 찾고 조망과 일조, 프라이버시 요소를 비교해
  합리적인 선택에 도움을 드립니다.
</p>
...
<div className={styles.textBox}>
  ...
  <div>두산위브더제니스 청주 센트럴파크가 자부심으로 완성됩니다.</div>
      ...
      <img
				...
				src={page1}
				alt="두산위브더제니스청주센트럴파크호수배치도-image1"
