...
<Helmet>
  {/* 페이지별 메타 */}
  <title>두산위브더제니스 청주 센트럴파크 - 단지배치도</title>
  <meta
    name="description"
    content="두산위브더제니스 청주 센트럴파크 단지배치도를 통해 동별 위치, 조경, 커뮤니티, 주차·보행 동선 설계를 확인하세요. 생활 편의를 고려한 최적 배치를 안내합니다."
  />
  ...
  <meta property="og:title" content="두산위브더제니스 청주 센트럴파크 - 단지배치도" />
  <meta
    property="og:description"
    content="동·호 배치, 조경·커뮤니티, 주차·보행 동선까지 생활 편의를 극대화한 단지 배치를 확인하세요."
  />
  ...
  <meta name="twitter:title" content="두산위브더제니스 청주 센트럴파크 - 단지배치도" />
  <meta
    name="twitter:description"
    content="조경·커뮤니티·주차·동선 계획을 한눈에 확인할 수 있는 단지배치도 안내."
  />
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "@type": "WebPage",
      "name": "두산위브더제니스 청주 센트럴파크 - 단지배치도",
      "url": "https://sinbiapt.co.kr/ComplexGuide/intro",
      "description":
        "두산위브더제니스 청주 센트럴파크 단지배치도: 동별 위치, 조경, 커뮤니티 시설, 주차·보행 동선 설계를 확인하세요.",
      "primaryImageOfPage": {
        "@type": "ImageObject",
...
<h1 className={styles.screenReaderOnly}>
  두산위브더제니스 청주 센트럴파크 - 단지배치도
</h1>
<p className={styles.screenReaderOnly}>
  단지 배치도 페이지는 두산위브더제니스 청주 센트럴파크의 전체 단지 구성도를 제공합니다.
  18개동 배치, 녹지·조경 계획, 커뮤니티 시설 위치와 주차·보행 동선 계획을
  시각적으로 안내하여 단지 내 생활을 쉽게 계획할 수 있도록 돕습니다.
</p>

<div className={styles.textBox}>
  <div>청주 도심의 새로운 하이엔드 기준</div>
  <div>두산위브더제니스 청주 센트럴파크가 자부심으로 완성됩니다.</div>
</div>
			...
			<img
				...
				src={page1}
				alt="두산위브더제니스청주센트럴파크단지배치도-image1"
