...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `하이엔드 대단지 스케일`,
    text2: `총 1,618세대 두산위브더제니스 대단지<br/>
            지하 2층~지상 31층 · 18개동 구성`,
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `사통팔달 교통 여건`,
    text2: `청주 1순환로·직지대로 등 주요 도로망 인접<br/>
            중부·경부고속도로 접근 용이`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `의료·생활 인프라 집약`,
    text2: `홈플러스·전통시장 등 생활 인프라 인접<br/>
            의료시설 접근이 편리한 도심 생활권`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `도심 속 녹지 프리미엄`,
    text2: `운천근린공원(조성 예정) 인접 녹지 환경<br/>
            산책과 휴식을 누리는 쾌적한 라이프`,
        ...
        <>
          ...
          <div className={styles.imageContainer}>
            <img
              ...
              alt="두산위브더제니스청주센트럴파크-mainimage1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox}>
            <div className={styles.mainImageTextSub}>
              브랜드 신뢰 두산위브{" "}
              <span className={styles.greyText}>하이엔드 프리미엄</span>
            </div>

            <div className={styles.mainImageTitleBox}>
              <div className={styles.mainImageText}>청주가 기다린 하이엔드 미래</div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text2}>
                  두산위브더제니스 청주 센트럴파크 POINT
                </div>
                <div className={styles.text3}>
                  - 청주 1순환로·직지대로 등 주요 도로망 인접, 청주 전역으로 편리한 이동성<br />
                  - 홈플러스·전통시장·의료시설 등 도심 생활 인프라 밀집<br />
                  - 운천근린공원(조성 예정) 인접, 도심 속 쾌적한 녹지 환경<br />
                  - 총 1,618세대 하이엔드 대단지와 차별화된 커뮤니티 구성
                </div>
              ...
              <div className={styles.menuBox}>
                <img
                  src={section1_Image1}
                  alt="두산위브더제니스청주센트럴파크브랜드소개-image2"
                  loading="lazy"
                  decoding="async"
                />
              ...
              <div className={styles.textBox}>
                ...
                <div className={styles.subTitle}>
                  ...
                  <div className={styles.subText}>
                    ...
                    <br />
                    두산위브더제니스청주센트럴파크가 함께합니다
                  </div>
                </div>
              </div>
              <img
                src={section8Img3}
                alt="두산위브더제니스청주센트럴파크입지환경소개-image2"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="두산위브더제니스청주센트럴파크아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="두산위브더제니스청주센트럴파크브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>두산위브더제니스청주센트럴파크</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/xykgwvav"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="두산위브더제니스청주센트럴파크오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="두산위브더제니스청주센트럴파크mobilemain-image1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
            <div className={styles.mainImageTextSub1}>
              청주의 새로운 시작, 높은 미래가치<br/>
              브랜드 신뢰 두산위브
              <br />
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container7}>
            ...
            <img
              src={section8Img3}
              alt="두산위브더제니스청주센트럴파크모바일 입지안내 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 두산위브더제니스청주센트럴파크에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="두산위브더제니스청주센트럴파크모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="두산위브더제니스청주센트럴파크브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="두산위브더제니스청주센트럴파크오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
