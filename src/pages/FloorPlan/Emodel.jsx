...
<Helmet>
  {/* 핵심 SEO 페이지: E-모델하우스 */}
  <title>두산위브더제니스 청주 센트럴파크 - E-모델하우스</title>
  <meta
    name="description"
    content="두산위브더제니스 청주 센트럴파크 E-모델하우스를 온라인에서 편리하게 둘러보세요. VR 가상 투어와 전용 59·74·84·114㎡ 세대별 평면도, 인테리어를 실감 나게 확인하실 수 있습니다."
  />
  ...
  <meta property="og:title" content="두산위브더제니스 청주 센트럴파크 - E-모델하우스" />
  <meta
    property="og:description"
    content="두산위브더제니스 청주 센트럴파크 E-모델하우스: VR 투어와 세대별 평면도·인테리어를 통해 실제 같은 공간을 체험하세요."
  />
  ...
  <meta name="twitter:title" content="두산위브더제니스 청주 센트럴파크 - E-모델하우스" />
  <meta
    name="twitter:description"
    content="두산위브더제니스 청주 센트럴파크 E-모델하우스를 온라인으로 체험하세요. VR 투어와 전용 59·74·84·114㎡ 평면도, 인테리어를 한눈에."
  />
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "@type": "WebPage",
      "name": "두산위브더제니스 청주 센트럴파크 - E-모델하우스",
      "url": "https://sinbiapt.co.kr/FloorPlan/Emodel",
      "description":
        "두산위브더제니스 청주 센트럴파크 E-모델하우스를 온라인에서 편리하게 둘러보세요. VR 가상 투어와 전용 59·74·84·114㎡ 세대별 평면도를 확인할 수 있습니다.",
      "primaryImageOfPage": {
        "@type": "ImageObject",
      ...
      <h1 className={styles.screenReaderOnly}>두산위브더제니스청주센트럴파크- E-모델하우스</h1>
