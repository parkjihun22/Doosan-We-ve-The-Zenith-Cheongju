...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://formspree.io/f/xykgwvav", {
        method: "POST",
...
<Helmet>
  ...
  <title>두산위브더제니스 청주 센트럴파크 - 관심고객등록</title>
  <meta
    name="description"
    content="두산위브더제니스 청주 센트럴파크 관심고객 등록 시 모델하우스 오픈·방문예약, 청약 일정, 현장 위치 등 최신 정보를 가장 먼저 받아보실 수 있습니다."
  />
  ...
  <meta property="og:title" content="두산위브더제니스 청주 센트럴파크 - 관심고객등록" />
  <meta
  ...
  <meta name="twitter:title" content="두산위브더제니스 청주 센트럴파크 - 관심고객등록" />
  <meta
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "@type": "WebPage",
      "name": "두산위브더제니스 청주 센트럴파크 - 관심고객등록",
      "url": "https://sinbiapt.co.kr/Promotion/Customer",
      "description":
        "두산위브더제니스 청주 센트럴파크 관심고객 등록 시 모델하우스 방문예약, 청약 일정, 현장 위치 등 주요 정보를 우선 제공해 드립니다.",
      "primaryImageOfPage": {
        "@type": "ImageObject",
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>두산위브더제니스청주센트럴파크</h2>
